...
VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_sequent__TOP__riscv_soc__u_core__u_core__0(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_sequent__TOP__riscv_soc__u_core__u_core__0\n"); );
    // Init
    CData/*1:0*/ __Vdly__u_mmu__DOT__state_q;
    __Vdly__u_mmu__DOT__state_q = 0;
    QData/*62:0*/ __Vdly__u_muldiv__DOT__divisor_q;
    __Vdly__u_muldiv__DOT__divisor_q = 0;
    IData/*31:0*/ __Vdly__u_muldiv__DOT__q_mask_q;
    __Vdly__u_muldiv__DOT__q_mask_q = 0;
    // Body
    vlSelf->__Vdly__u_csr__DOT__reset_q = vlSelf->__PVT__u_csr__DOT__reset_q;
    vlSelf->__Vdly__u_muldiv__DOT__quotient_q = vlSelf->__PVT__u_muldiv__DOT__quotient_q;
    __Vdly__u_muldiv__DOT__divisor_q = vlSelf->__PVT__u_muldiv__DOT__divisor_q;
    vlSelf->__Vdly__u_muldiv__DOT__dividend_q = vlSelf->__PVT__u_muldiv__DOT__dividend_q;
    __Vdly__u_muldiv__DOT__q_mask_q = vlSelf->__PVT__u_muldiv__DOT__q_mask_q;
    __Vdly__u_mmu__DOT__state_q = vlSelf->__PVT__u_mmu__DOT__state_q;
    vlSelf->__Vdly__u_lsu__DOT__mem_wr_q = vlSelf->__PVT__u_lsu__DOT__mem_wr_q;
    vlSelf->__Vdly__u_lsu__DOT__mem_invalidate_q = vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q;
    vlSelf->__Vdly__u_lsu__DOT__mem_flush_q = vlSelf->__PVT__u_lsu__DOT__mem_flush_q;
    vlSelf->__PVT__u_fetch__DOT__skid_valid_q = ((1U 
                                                  & (~ (IData)(vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i))) 
                                                 && ((IData)(vlSelf->__PVT__fetch_valid_w) 
                                                     & (~ (IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__fetch_accept_o))));
    vlSelf->__PVT__u_fetch__DOT__fetch_page_fault_q 
        = ((~ (IData)(vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i)) 
           & (((IData)(vlSelf->__PVT__mmu_ifetch_rd_w) 
               & (IData)(vlSelf->__PVT__mmu_ifetch_accept_w)) 
              & (IData)(vlSelf->__PVT__u_mmu__DOT__pc_fault_r)));
    vlSelf->__PVT__u_csr__DOT__writeback_en_q = ((1U 
                                                  & (~ (IData)(vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i))) 
                                                 && (((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__csr_opcode_valid_o) 
                                                      & (~ (IData)(vlSelf->__PVT__csr_stall_w))) 
    ...
    vlSelf->__PVT__u_csr__DOT__writeback_squash_q = 
        ((1U & (~ (IData)(vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i))) 
         && ((((IData)(vlSelf->__PVT__u_csr__DOT__valid_unit_inst_w) 
               & (((~ (IData)(vlSelf->__PVT__u_csr__DOT__exception_m_w)) 
                   & (IData)(vlSelf->__PVT__u_csr__DOT__take_exception_r)) 
                  | (IData)(vlSelf->__PVT__u_csr__DOT__take_intr_r))) 
    ...
    if (vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i) {
        vlSelf->__Vdly__u_muldiv__DOT__dividend_q = 0U;
        __Vdly__u_muldiv__DOT__divisor_q = 0ULL;
        vlSelf->__Vdly__u_muldiv__DOT__quotient_q = 0U;
        __Vdly__u_muldiv__DOT__q_mask_q = 0U;
        vlSelf->__PVT__u_muldiv__DOT__divisor_q = __Vdly__u_muldiv__DOT__divisor_q;
        vlSelf->__PVT__u_muldiv__DOT__q_mask_q = __Vdly__u_muldiv__DOT__q_mask_q;
        vlSelf->__Vdly__u_lsu__DOT__mem_wr_q = 0U;
        vlSelf->__Vdly__u_lsu__DOT__mem_invalidate_q = 0U;
        vlSelf->__Vdly__u_lsu__DOT__mem_flush_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__skid_buffer_q = 0ULL;
        vlSelf->__PVT__u_fetch__DOT__pc_d_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__fetch_pc_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__icache_fetch_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__branch_pc_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__branch_valid_q = 0U;
        vlSelf->__PVT__u_csr__DOT__pc_m_q = 0U;
        vlSelf->__PVT__u_arb__DOT__read_hold_q = 0U;
        vlSelf->__PVT__u_arb__DOT__src_mmu_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__mem_req_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__store_q = 0U;
        vlSelf->__PVT__u_csr__DOT__writeback_idx_q = 0U;
    } else {
        if (vlSelf->__PVT__u_muldiv__DOT__div_start_w) {
            vlSelf->__Vdly__u_muldiv__DOT__dividend_q 
                = (((IData)(vlSelf->__PVT__u_muldiv__DOT__signed_operation_w) 
                    & (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_ra_operand_r 
                       >> 0x1fU)) ? (- vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_ra_operand_r)
                    : vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_ra_operand_r);
            __Vdly__u_muldiv__DOT__divisor_q = (((IData)(vlSelf->__PVT__u_muldiv__DOT__signed_operation_w) 
                                                ...
                                                ((QData)((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r)) 
                                                 << 0x1fU));
            vlSelf->__Vdly__u_muldiv__DOT__quotient_q = 0U;
            __Vdly__u_muldiv__DOT__q_mask_q = 0x80000000U;
        } else if ((1U & (~ (IData)(vlSelf->__PVT__u_muldiv__DOT__div_complete_w)))) {
            if (vlSelf->__PVT__u_muldiv__DOT__div_busy_q) {
                if ((vlSelf->__PVT__u_muldiv__DOT__divisor_q 
                     <= (QData)((IData)(vlSelf->__PVT__u_muldiv__DOT__dividend_q)))) {
                    vlSelf->__Vdly__u_muldiv__DOT__dividend_q 
                        = (vlSelf->__PVT__u_muldiv__DOT__dividend_q 
                           - (IData)(vlSelf->__PVT__u_muldiv__DOT__divisor_q));
                    vlSelf->__Vdly__u_muldiv__DOT__quotient_q 
                        = (vlSelf->__PVT__u_muldiv__DOT__quotient_q 
                           | vlSelf->__PVT__u_muldiv__DOT__q_mask_q);
                }
                __Vdly__u_muldiv__DOT__divisor_q = 
                    (0x3fffffffffffffffULL & (vlSelf->__PVT__u_muldiv__DOT__divisor_q 
                                              >> 1U));
                __Vdly__u_muldiv__DOT__q_mask_q = (vlSelf->__PVT__u_muldiv__DOT__q_mask_q 
                                                   >> 1U);
            }
        ...
        vlSelf->__PVT__u_muldiv__DOT__divisor_q = __Vdly__u_muldiv__DOT__divisor_q;
        vlSelf->__PVT__u_muldiv__DOT__q_mask_q = __Vdly__u_muldiv__DOT__q_mask_q;
        if ((1U & (~ (((((IData)(vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q) 
                         | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_flush_q)) 
                        | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_rd_q)) 
                       | (0U != (IData)(vlSelf->__PVT__mmu_lsu_wr_w))) 
                      & (~ (IData)(vlSelf->__PVT__mmu_lsu_accept_w)))))) {
            vlSelf->__Vdly__u_lsu__DOT__mem_wr_q = 0U;
            vlSelf->__Vdly__u_lsu__DOT__mem_wr_q = 
                ((((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__lsu_opcode_valid_o) 
                   & (IData)((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                              >> 0x25U))) & (~ (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_r)))
                  ? 0xfU : ((((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__lsu_opcode_valid_o) 
                              & (IData)((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                                         >> 0x24U))) 
                             & (~ (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_r)))
                             ? ((2U == (3U & vlSelf->__PVT__u_lsu__DOT__mem_addr_r))
                                 ? 0xcU : 3U) : (((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__lsu_opcode_valid_o) 
                                                  & (IData)(
        ...
        if ((1U & (~ (((((IData)(vlSelf->__PVT__arb_cpu_invalidate_w) 
                         | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_flush_q)) 
                        | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_rd_q)) 
                       | (0U != (IData)(vlSelf->__PVT__u_lsu__DOT__mem_wr_q))) 
                      & (~ (IData)(vlSelf->__PVT__mmu_lsu_accept_w)))))) {
            vlSelf->__Vdly__u_lsu__DOT__mem_invalidate_q = 0U;
            vlSelf->__Vdly__u_lsu__DOT__mem_invalidate_q 
                = ((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__lsu_opcode_valid_o) 
                   & ((IData)((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                               >> 0x29U)) & (0x3a2U 
        ...
        if ((1U & (~ (((((IData)(vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q) 
                         | (IData)(vlSelf->__PVT__arb_cpu_flush_w)) 
                        | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_rd_q)) 
                       | (0U != (IData)(vlSelf->__PVT__u_lsu__DOT__mem_wr_q))) 
                      & (~ (IData)(vlSelf->__PVT__mmu_lsu_accept_w)))))) {
            vlSelf->__Vdly__u_lsu__DOT__mem_flush_q = 0U;
            vlSelf->__Vdly__u_lsu__DOT__mem_flush_q 
                = ((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__lsu_opcode_valid_o) 
                   & ((IData)((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                               >> 0x29U)) & (0x3a0U 
                                             == (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__inst_q 
        ...
        vlSelf->__PVT__u_fetch__DOT__skid_buffer_q 
            = (((IData)(vlSelf->__PVT__fetch_valid_w) 
                & (~ (IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__fetch_accept_o)))
                ? (((QData)((IData)(vlSelf->__PVT__fetch_pc_w)) 
                    << 0x20U) | (QData)((IData)(vlSelf->__PVT__fetch_instr_w)))
                : 0ULL);
        if (((IData)(vlSelf->__PVT__mmu_ifetch_rd_w) 
             & (IData)(vlSelf->__PVT__mmu_ifetch_accept_w))) {
            vlSelf->__PVT__u_fetch__DOT__pc_d_q = vlSelf->__PVT__mmu_ifetch_pc_w;
            vlSelf->__PVT__u_fetch__DOT__icache_fetch_q 
                = (1U & (~ (IData)(vlSelf->__PVT__u_mmu__DOT__pc_fault_r)));
        } else if (vlSymsp->TOP__riscv_soc__u_core__u_icache.__PVT__req_valid_o) {
            vlSelf->__PVT__u_fetch__DOT__icache_fetch_q = 0U;
        }
        if ((1U & (~ (IData)(vlSelf->__PVT__u_fetch__DOT__stall_w)))) {
            vlSelf->__PVT__u_fetch__DOT__fetch_pc_q 
                = ((IData)(4U) + vlSelf->__PVT__mmu_ifetch_pc_w);
        }
        if ((1U & ((IData)(vlSelf->__PVT__u_fetch__DOT__stall_w) 
                   | (~ (IData)(vlSelf->__PVT__u_fetch__DOT__active_q))))) {
            vlSelf->__PVT__u_fetch__DOT__branch_valid_q 
                = vlSelf->__PVT__u_fetch__DOT__branch_w;
        ...
        if (((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__csr_opcode_valid_o) 
             & (~ (IData)(vlSelf->__PVT__csr_stall_w)))) {
            vlSelf->__PVT__u_csr__DOT__pc_m_q = vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__pc_q;
            vlSelf->__PVT__u_csr__DOT__writeback_idx_q 
                = (0x1fU & (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__inst_q 
                            >> 7U));
        }
        if ((((IData)(vlSelf->__PVT__mem_d_rd_o) | 
              (0U != (IData)(vlSelf->__PVT__mem_d_wr_o))) 
             & (~ (IData)(vlSymsp->TOP__riscv_soc__u_core.__PVT__dport_bridge_accept_w)))) {
            vlSelf->__PVT__u_arb__DOT__read_hold_q = 1U;
            vlSelf->__PVT__u_arb__DOT__src_mmu_q = vlSelf->__PVT__u_arb__DOT__src_mmu_w;
        } else if (vlSymsp->TOP__riscv_soc__u_core.__PVT__dport_bridge_accept_w) {
            vlSelf->__PVT__u_arb__DOT__read_hold_q = 0U;
        }
        if (((0U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
             & ((IData)(vlSelf->__PVT__u_mmu__DOT__itlb_miss_w) 
                | (IData)(vlSelf->__PVT__u_mmu__DOT__dtlb_miss_w)))) {
            vlSelf->__PVT__u_mmu__DOT__mem_req_q = 1U;
        } else if ((((((1U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
                       & (IData)(vlSelf->__PVT__arb_mmu_ack_w)) 
                      & (~ (IData)(vlSelf->__PVT__arb_mmu_error_w))) 
                     & vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r) 
                    & (~ (IData)((0U != (0xeU & vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r)))))) {
            vlSelf->__PVT__u_mmu__DOT__mem_req_q = 1U;
        } else if (((IData)(vlSelf->__PVT__u_arb__DOT__src_mmu_w) 
                    & (IData)(vlSymsp->TOP__riscv_soc__u_core.__PVT__dport_bridge_accept_w))) {
            vlSelf->__PVT__u_mmu__DOT__mem_req_q = 0U;
        }
        if ((0U != (IData)(vlSelf->__PVT__u_lsu__DOT__mem_wr_q))) {
            vlSelf->__PVT__u_mmu__DOT__store_q = ((IData)(vlSelf->__PVT__mmu_lsu_accept_w)
                                                   ? 0U
    ...
    if (vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i) {
        vlSelf->__PVT__u_mmu__DOT__itlb_valid_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_cacheable_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_unaligned_st_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__load_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__dtlb_valid_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__lsu_in_addr_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__itlb_entry_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__itlb_va_addr_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__dtlb_entry_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__dtlb_va_addr_q = 0U;
        vlSelf->__PVT__u_fetch__DOT__active_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_unaligned_ld_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_addr_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__pte_addr_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__pte_entry_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__virt_addr_q = 0U;
        vlSelf->__PVT__u_mmu__DOT__dtlb_req_q = 0U;
        __Vdly__u_mmu__DOT__state_q = 0U;
    } else {
        if (vlSelf->__PVT__mmu_flush_w) {
            vlSelf->__PVT__u_mmu__DOT__itlb_valid_q = 0U;
            vlSelf->__PVT__u_mmu__DOT__dtlb_valid_q = 0U;
        } else {
            if (((3U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
                 & (~ (IData)(vlSelf->__PVT__u_mmu__DOT__dtlb_req_q)))) {
                vlSelf->__PVT__u_mmu__DOT__itlb_valid_q = 1U;
            }
            if (((3U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
                 & (IData)(vlSelf->__PVT__u_mmu__DOT__dtlb_req_q))) {
                vlSelf->__PVT__u_mmu__DOT__dtlb_valid_q = 1U;
            }
        }
        if (vlSelf->__PVT__u_lsu__DOT__mem_rd_q) {
            vlSelf->__PVT__u_mmu__DOT__load_q = (1U 
                                                 & (~ (IData)(vlSelf->__PVT__mmu_lsu_accept_w)));
        }
        if (((IData)(vlSelf->__PVT__u_mmu__DOT__load_w) 
        ...
        if ((1U & (~ (((((IData)(vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q) 
            ...
            vlSelf->__PVT__u_lsu__DOT__mem_unaligned_st_q 
                = ((~ (IData)(vlSelf->__PVT__u_lsu__DOT__load_inst_w)) 
                   & (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_r));
            vlSelf->__PVT__u_lsu__DOT__mem_unaligned_ld_q 
                = ((IData)(vlSelf->__PVT__u_lsu__DOT__load_inst_w) 
                   & (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_r));
            vlSelf->__PVT__u_lsu__DOT__mem_addr_q = 0U;
            vlSelf->__PVT__u_lsu__DOT__mem_addr_q = vlSelf->__PVT__u_lsu__DOT__mem_addr_r;
        }
        if (((3U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
             & (~ (IData)(vlSelf->__PVT__u_mmu__DOT__dtlb_req_q)))) {
            vlSelf->__PVT__u_mmu__DOT__itlb_entry_q 
                = vlSelf->__PVT__u_mmu__DOT__pte_entry_q;
            vlSelf->__PVT__u_mmu__DOT__itlb_va_addr_q 
                = (vlSelf->__PVT__u_mmu__DOT__virt_addr_q 
                   >> 0xcU);
        }
        if (((3U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
             & (IData)(vlSelf->__PVT__u_mmu__DOT__dtlb_req_q))) {
        ...
        if (vlSelf->__PVT__u_fetch__DOT__branch_w) {
            vlSelf->__PVT__u_fetch__DOT__active_q = 1U;
        }
        if (((0U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
             & ((IData)(vlSelf->__PVT__u_mmu__DOT__itlb_miss_w) 
                | (IData)(vlSelf->__PVT__u_mmu__DOT__dtlb_miss_w)))) {
            vlSelf->__PVT__u_mmu__DOT__pte_addr_q = 
                (VL_SHIFTL_III(32,32,32, (((IData)(vlSelf->__PVT__u_mmu__DOT__vm_enable_w) 
                                           << 0x1fU) 
                                          | (0x7fffffffU 
                                             & vlSelf->__PVT__u_csr__DOT__csr_satp_q)), 0xcU) 
                 + (0xffcU & (vlSelf->__PVT__u_mmu__DOT__request_addr_w 
                              >> 0x14U)));
            vlSelf->__PVT__u_mmu__DOT__virt_addr_q 
                = vlSelf->__PVT__u_mmu__DOT__request_addr_w;
            vlSelf->__PVT__u_mmu__DOT__dtlb_req_q = vlSelf->__PVT__u_mmu__DOT__dtlb_miss_w;
            __Vdly__u_mmu__DOT__state_q = 1U;
        } else if (((1U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
                    & (IData)(vlSelf->__PVT__arb_mmu_ack_w))) {
            if ((1U & ((IData)(vlSelf->__PVT__arb_mmu_error_w) 
                       | (~ vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r)))) {
                vlSelf->__PVT__u_mmu__DOT__pte_entry_q = 0U;
                __Vdly__u_mmu__DOT__state_q = 3U;
            } else if ((IData)((0U != (0xeU & vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r)))) {
                vlSelf->__PVT__u_mmu__DOT__pte_entry_q 
                    = (((0xfffff000U & VL_SHIFTL_III(32,32,32, vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r, 2U)) 
                        | VL_SHIFTL_III(32,32,32, (0x3ffU 
                                                   & (vlSelf->__PVT__u_mmu__DOT__request_addr_w 
                                                      >> 0xcU)), 0xcU)) 
                       | (0x3ffU & vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r));
                __Vdly__u_mmu__DOT__state_q = 3U;
            } else {
                vlSelf->__PVT__u_mmu__DOT__pte_addr_q 
                    = ((0xfffff000U & (vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r 
                                       << 2U)) + (0xffcU 
                                                  & (vlSelf->__PVT__u_mmu__DOT__request_addr_w 
                                                     >> 0xaU)));
                __Vdly__u_mmu__DOT__state_q = 2U;
            }
        } else if (((2U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q)) 
                    & (IData)(vlSelf->__PVT__arb_mmu_ack_w))) {
            if ((1U & vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r)) {
                vlSelf->__PVT__u_mmu__DOT__pte_entry_q 
                    = ((0xfffff000U & VL_SHIFTL_III(32,32,32, vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r, 2U)) 
                       | (0x3ffU & vlSymsp->TOP__riscv_soc.__PVT__u_soc__DOT__u_axi_tap__DOT__outport_rdata_r));
                __Vdly__u_mmu__DOT__state_q = 3U;
        ...
        } else if ((3U == (IData)(vlSelf->__PVT__u_mmu__DOT__state_q))) {
            __Vdly__u_mmu__DOT__state_q = 0U;
        }
    }
    vlSelf->__PVT__u_mmu__DOT__state_q = __Vdly__u_mmu__DOT__state_q;
    vlSelf->u_lsu__DOT____VdfgExtracted_h68300021__0 
        = ((IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_ld_q) 
           | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_st_q));
    if (vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i) {
        vlSelf->__PVT__u_csr__DOT__csr_mepc_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_sr_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_mcause_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_mtvec_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_mip_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_mie_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_mpriv_q = 3U;
        vlSelf->__PVT__u_csr__DOT__csr_mcycle_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_mscratch_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_medeleg_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_mideleg_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_sepc_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_stvec_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_scause_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_stval_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_satp_q = 0U;
        vlSelf->__PVT__u_csr__DOT__csr_sscratch_q = 0U;
    } else {
        if (((((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__csr_opcode_valid_o) 
               & ((IData)(vlSelf->__PVT__u_csr__DOT__set_r) 
                  | (IData)(vlSelf->__PVT__u_csr__DOT__clr_r))) 
              & (0x7b2U == (0xfffU & vlSelf->__PVT__u_csr__DOT__imm12_r))) 
             & (~ (IData)(vlSelf->__PVT__u_csr__DOT__csr_access_fault_w)))) {
            if (VL_UNLIKELY((0U == (0xff000000U & vlSelf->__PVT__u_csr__DOT__data_r)))) {
                VL_FINISH_MT("../core/core/rv32imsu/riscv_csr.v", 926, "");
                VL_FINISH_MT("../core/core/rv32imsu/riscv_csr.v", 927, "");
            } else if (VL_UNLIKELY((0x1000000U == (0xff000000U 
                                                   & vlSelf->__PVT__u_csr__DOT__data_r)))) {
                VL_WRITEF("%c",8,(0xffU & vlSelf->__PVT__u_csr__DOT__data_r));
            }
        }
        vlSelf->__PVT__u_csr__DOT__csr_mepc_q = vlSelf->__PVT__u_csr__DOT__csr_mepc_r;
        vlSelf->__PVT__u_csr__DOT__csr_sr_q = vlSelf->__PVT__u_csr__DOT__csr_sr_r;
        vlSelf->__PVT__u_csr__DOT__csr_mcause_q = vlSelf->__PVT__u_csr__DOT__csr_mcause_r;
        vlSelf->__PVT__u_csr__DOT__csr_mtvec_q = vlSelf->__PVT__u_csr__DOT__csr_mtvec_r;
        vlSelf->__PVT__u_csr__DOT__csr_mip_q = vlSelf->__PVT__u_csr__DOT__csr_mip_r;
        vlSelf->__PVT__u_csr__DOT__csr_mie_q = vlSelf->__PVT__u_csr__DOT__csr_mie_r;
        vlSelf->__PVT__u_csr__DOT__csr_mpriv_q = vlSelf->__PVT__u_csr__DOT__csr_mpriv_r;
        vlSelf->__PVT__u_csr__DOT__csr_mcycle_q = vlSelf->__PVT__u_csr__DOT__csr_mcycle_r;
        vlSelf->__PVT__u_csr__DOT__csr_mscratch_q = vlSelf->__PVT__u_csr__DOT__csr_mscratch_r;
        vlSelf->__PVT__u_csr__DOT__csr_medeleg_q = vlSelf->__PVT__u_csr__DOT__csr_medeleg_r;
        vlSelf->__PVT__u_csr__DOT__csr_mideleg_q = vlSelf->__PVT__u_csr__DOT__csr_mideleg_r;
        vlSelf->__PVT__u_csr__DOT__csr_sepc_q = vlSelf->__PVT__u_csr__DOT__csr_sepc_r;
        vlSelf->__PVT__u_csr__DOT__csr_stvec_q = vlSelf->__PVT__u_csr__DOT__csr_stvec_r;
        vlSelf->__PVT__u_csr__DOT__csr_scause_q = vlSelf->__PVT__u_csr__DOT__csr_scause_r;
        vlSelf->__PVT__u_csr__DOT__csr_stval_q = vlSelf->__PVT__u_csr__DOT__csr_stval_r;
        vlSelf->__PVT__u_csr__DOT__csr_satp_q = vlSelf->__PVT__u_csr__DOT__csr_satp_r;
        vlSelf->__PVT__u_csr__DOT__csr_sscratch_q = vlSelf->__PVT__u_csr__DOT__csr_sscratch_r;
    }
...
VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_sequent__TOP__riscv_soc__u_core__u_core__1(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_sequent__TOP__riscv_soc__u_core__u_core__1\n"); );
    // Init
    ...
    if (vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i) {
        ...
        vlSelf->__PVT__u_lsu__DOT__mem_req_tag_q = 0U;
        vlSelf->__PVT__u_csr__DOT__writeback_value_q = 0U;
        vlSelf->__PVT__u_muldiv__DOT__wb_result_q = 0U;
        vlSelf->__PVT__u_muldiv__DOT__wb_rd_q = 0U;
        vlSelf->__PVT__u_lsu__DOT__mem_rd_q = 0U;
        vlSelf->__PVT__u_muldiv__DOT__mult_result_q = 0U;
        vlSelf->__PVT__u_muldiv__DOT__div_inst_q = 0U;
        vlSelf->__PVT__u_muldiv__DOT__invert_res_q = 0U;
        vlSelf->__PVT__u_muldiv__DOT__rd_q = 0U;
        vlSelf->__PVT__u_muldiv__DOT__div_busy_q = 0U;
    } else {
        if ((1U & (~ (((((IData)(vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q) 
                         | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_flush_q)) 
                        | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_rd_q)) 
            ...
            if ((((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__lsu_opcode_valid_o) 
                ...
                vlSelf->__PVT__u_lsu__DOT__mem_data_wr_q 
                    = vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r;
                         ...
                         & (IData)((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                                    >> 0x24U))) & (~ (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_r)))) {
                vlSelf->__PVT__u_lsu__DOT__mem_data_wr_q 
                    = ((2U == (3U & vlSelf->__PVT__u_lsu__DOT__mem_addr_r))
                        ? (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r 
                           << 0x10U) : (0xffffU & vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r));
            } else if (((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__lsu_opcode_valid_o) 
                        & (IData)((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                                   >> 0x23U)))) {
                vlSelf->__PVT__u_lsu__DOT__mem_data_wr_q 
                    = ((2U & vlSelf->__PVT__u_lsu__DOT__mem_addr_r)
                            ...
                            ? (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r 
                               << 0x18U) : (0xff0000U 
                                            & (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r 
                                               << 0x10U)))
                        : ((1U & vlSelf->__PVT__u_lsu__DOT__mem_addr_r)
                            ? (0xff00U & (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r 
                                          << 8U)) : 
                           (0xffU & vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r)));
            }
            vlSelf->__PVT__u_lsu__DOT__mem_req_tag_q = 0U;
            vlSelf->__PVT__u_lsu__DOT__mem_req_tag_q 
                = ((0x700U & (IData)(vlSelf->__PVT__u_lsu__DOT__mem_req_tag_q)) 
                   | (((IData)((0ULL != (0x120000000ULL 
                                         & vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q))) 
                       << 7U) | ((0x60U & (vlSelf->__PVT__u_lsu__DOT__mem_addr_r 
                                           << 5U)) 
                                 | (0x1fU & (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__inst_q 
                                             >> 7U)))));
            vlSelf->__PVT__u_lsu__DOT__mem_req_tag_q 
                = ((0xffU & (IData)(vlSelf->__PVT__u_lsu__DOT__mem_req_tag_q)) 
                   | (((IData)(vlSelf->__PVT__u_lsu__DOT__load_signed_inst_w) 
                       << 0xaU) | (0x300U & (((IData)(
                                                      (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                                                       >> 0x1eU)) 
                                              | (IData)(
        ...
        if (((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__csr_opcode_valid_o) 
             & (~ (IData)(vlSelf->__PVT__csr_stall_w)))) {
            vlSelf->__PVT__u_csr__DOT__writeback_value_q 
                = vlSelf->__PVT__u_csr__DOT__result_r;
        }
        vlSelf->__PVT__u_muldiv__DOT__wb_result_q = 
            ((IData)(vlSelf->__PVT__u_muldiv__DOT__div_complete_w)
              ? ((IData)(vlSelf->__PVT__u_muldiv__DOT__div_inst_q)
                  ? ((IData)(vlSelf->__PVT__u_muldiv__DOT__invert_res_q)
                      ? (- vlSelf->__PVT__u_muldiv__DOT__quotient_q)
                      : vlSelf->__PVT__u_muldiv__DOT__quotient_q)
                  : ((IData)(vlSelf->__PVT__u_muldiv__DOT__invert_res_q)
                      ? (- vlSelf->__PVT__u_muldiv__DOT__dividend_q)
                      : vlSelf->__PVT__u_muldiv__DOT__dividend_q))
              : vlSelf->__PVT__u_muldiv__DOT__mult_result_q);
        vlSelf->__PVT__u_muldiv__DOT__wb_rd_q = ((IData)(vlSelf->__PVT__u_muldiv__DOT__mult_busy_q)
                                                  ? (IData)(vlSelf->__PVT__u_muldiv__DOT__rd_q)
                                                  : 
                                                 ((IData)(vlSelf->__PVT__u_muldiv__DOT__div_complete_w)
                                                   ? (IData)(vlSelf->__PVT__u_muldiv__DOT__rd_q)
                                                   : 0U));
        if ((1U & (~ (((((IData)(vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q) 
                         | (IData)(vlSelf->__PVT__u_lsu__DOT__mem_flush_q)) 
                        | (IData)(vlSelf->__PVT__mmu_lsu_rd_w)) 
                       | (0U != (IData)(vlSelf->__PVT__u_lsu__DOT__mem_wr_q))) 
                      & (~ (IData)(vlSelf->__PVT__mmu_lsu_accept_w)))))) {
            vlSelf->__PVT__u_lsu__DOT__mem_rd_q = 0U;
            vlSelf->__PVT__u_lsu__DOT__mem_rd_q = (
                                                   ((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__lsu_opcode_valid_o) 
                                                    & (IData)(vlSelf->__PVT__u_lsu__DOT__load_inst_w)) 
                                                   & (~ (IData)(vlSelf->__PVT__u_lsu__DOT__mem_unaligned_r)));
        }
        vlSelf->__PVT__u_muldiv__DOT__mult_result_q 
            = vlSelf->__PVT__u_muldiv__DOT__result_r;
        if ((((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__muldiv_opcode_valid_o) 
            ...
            vlSelf->__PVT__u_muldiv__DOT__rd_q = (0x1fU 
                                                  & (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__inst_q 
                                                     >> 7U));
        } else if ((1U & (~ (IData)(vlSelf->__PVT__u_muldiv__DOT__div_busy_q)))) {
            vlSelf->__PVT__u_muldiv__DOT__rd_q = 0U;
        }
        if (vlSelf->__PVT__u_muldiv__DOT__div_start_w) {
            vlSelf->__PVT__u_muldiv__DOT__div_inst_q 
                = vlSelf->__PVT__u_muldiv__DOT__div_operation_w;
            vlSelf->__PVT__u_muldiv__DOT__invert_res_q 
                = (1U & ((((IData)((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                                    >> 0x33U)) & ((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_ra_operand_r 
                                                   >> 0x1fU) 
                                                  != 
                                                  (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r 
                                                   >> 0x1fU))) 
                          & (0U != vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_rb_operand_r)) 
                         | ((IData)((vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_instr_q 
                                     >> 0x35U)) & (vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__opcode_ra_operand_r 
                                                   >> 0x1fU))));
            vlSelf->__PVT__u_muldiv__DOT__div_busy_q = 1U;
        } else if (vlSelf->__PVT__u_muldiv__DOT__div_complete_w) {
            vlSelf->__PVT__u_muldiv__DOT__div_busy_q = 0U;
        }
    }
    vlSelf->__PVT__u_muldiv__DOT__quotient_q = vlSelf->__Vdly__u_muldiv__DOT__quotient_q;
    vlSelf->__PVT__u_muldiv__DOT__dividend_q = vlSelf->__Vdly__u_muldiv__DOT__dividend_q;
    vlSelf->__PVT__u_muldiv__DOT__mult_busy_q = ((~ (IData)(vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i)) 
                                                 & (((IData)(vlSymsp->TOP__riscv_soc__u_core__u_core__u_decode.__PVT__muldiv_opcode_valid_o) 
                                                     & (~ (IData)(vlSelf->__PVT__muldiv_stall_w))) 
                                                    & (IData)(vlSelf->__PVT__u_muldiv__DOT__mult_inst_w)));
    vlSelf->__PVT__u_lsu__DOT__mem_invalidate_q = vlSelf->__Vdly__u_lsu__DOT__mem_invalidate_q;
    vlSelf->__PVT__u_lsu__DOT__mem_flush_q = vlSelf->__Vdly__u_lsu__DOT__mem_flush_q;
    vlSelf->__PVT__u_lsu__DOT__mem_wr_q = vlSelf->__Vdly__u_lsu__DOT__mem_wr_q;
...
VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_sequent__TOP__riscv_soc__u_core__u_core__2(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_sequent__TOP__riscv_soc__u_core__u_core__2\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_sequent__TOP__riscv_soc__u_core__u_core__3(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_sequent__TOP__riscv_soc__u_core__u_core__3\n"); );
    // Body
    ...
    vlSelf->__PVT__u_csr__DOT__readonly_r = (3U == 
                                             (3U & 
                                              (vlSelf->__PVT__u_csr__DOT__imm12_r 
                                               >> 0xaU)));
    if (vlSymsp->TOP.__Vcellinp__riscv_soc__rst_cpu_i) {
        vlSelf->__PVT__u_csr__DOT__branch_target_q = 0U;
        vlSelf->__PVT__u_csr__DOT__branch_q = 0U;
        vlSelf->__Vdly__u_csr__DOT__reset_q = 1U;
    } else if (vlSelf->__PVT__u_csr__DOT__reset_q) {
        vlSelf->__PVT__u_csr__DOT__branch_target_q 
            = vlSymsp->TOP.__Vcellinp__riscv_soc__reset_vector_i;
        vlSelf->__PVT__u_csr__DOT__branch_q = 1U;
        vlSelf->__Vdly__u_csr__DOT__reset_q = 0U;
    } else {
        vlSelf->__PVT__u_csr__DOT__branch_target_q 
            = vlSelf->__PVT__u_csr__DOT__branch_target_r;
        vlSelf->__PVT__u_csr__DOT__branch_q = vlSelf->__PVT__u_csr__DOT__branch_r;
    }
    vlSelf->__PVT__u_csr__DOT__reset_q = vlSelf->__Vdly__u_csr__DOT__reset_q;
}

VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__0(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__0\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__1(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__1\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__2(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__2\n"); );
    // Init
...
VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__3(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__3\n"); );
    // Body
...
VL_INLINE_OPT void Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__4(Vriscv_soc_riscv_core* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_soc_riscv_core___nba_comb__TOP__riscv_soc__u_core__u_core__4\n"); );
    // Init
