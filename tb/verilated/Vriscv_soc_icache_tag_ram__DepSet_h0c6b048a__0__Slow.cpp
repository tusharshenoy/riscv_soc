...
VL_ATTR_COLD void Vriscv_soc_icache_tag_ram___ctor_var_reset(Vriscv_soc_icache_tag_ram* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv_soc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_soc_icache_tag_ram___ctor_var_reset\n"); );
    // Body
